...
class Context(object):
    def __init__(self):
        ...
        self.edges = [] # edge 3-tuple: (line index, vertex 1 index, vertex 2 index)   if either vertex index is
                               # -1, the edge extends to infinity
        self.triangles = [] # 3-tuple of vertex indices
        self.polygons = {} # a dictionary of site:[edges] pairs
...
def computeVoronoiDiagram(points):
    ...
    (1) a list of 2-tuples, which are the x,y coordinates of the Voronoi diagram vertices
    (2) a list of 3-tuples (a,b,c) which are the equations of the lines in the Voronoi diagram: a*x + b*y = c
    (3) a list of 3-tuples, (l, v1, v2) representing edges of the Voronoi diagram. l is the index of the line, v1 and v2
        are the indices of the vertices at the end of the edge.  If v1 or v2 is -1, the line extends to infinity.
    """
